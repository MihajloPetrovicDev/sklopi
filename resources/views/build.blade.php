...
<body>
        ...
        <div class="d-flex mt-5 w-80p mx-auto align-items-center md-max-900px-d-block md-max-900px-mb-100px">
            ...
            <div class="w-60p md-max-900px-w-100p md-max-900px-mt-15px">
                <div class="w-80p mx-auto md-max-900px-w-100p">
                    ...
                    @else
                        <div class="mx-auto d-flex align-items-center w-fc">
                            <label class="fs-4 fw-light text-end" for="save-build-name-button">@lang('ui.build.name'):</label>

                            <p class="ml-10px mb-5px fs-2">{{ $build->name }}</p>
                        </div>
                    @endif
                </div>
            </div>
    ...
    @vite('resources/js/inits/build_init.js')
</body>
</html>