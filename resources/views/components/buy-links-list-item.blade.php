<div class="section-2 gap-5 w-100p mt-3 pb-0px" data-buy-link-id="{{ $buyLink->id }}">
    {{-- Top row --}}
    <div class="d-flex mt-1 md-max-1200px-d-block">
        {{-- Buy link name --}}
        <div class="w-48p md-max-1200px-w-90p">
        ...
        {{-- Buy link link --}}
        <div class="w-47p ml-5p md-max-1200px-w-90p md-max-1200px-ml-0px md-max-1200px-mt-5px">
    ...
    {{-- Bottom row --}}
    <div class="d-flex mt-3 md-max-1200px-d-block md-max-1200px-mt-5px">
        {{-- Buy link price --}}
        <div class="w-20p md-max-1200px-w-90p">
        ...
        <div class="d-flex w-75p ml-5p md-max-1200px-d-block md-max-1200px-w-90p md-max-1200px-ml-0px md-max-1200px-mt-5px">
            <div class="w-60p pr-10px md-max-1200px-w-100p md-max-1200px-pr-0px">
            ...
            <div class="w-40p md-max-1200px-w-40p md-max-600px-w-100p">
