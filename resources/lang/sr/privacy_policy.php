...
Korišćenjem našeg sajta, možemo prikupljati sledeće podatke:
    -Informacije o nalogu: E-mail adresa, korisničko ime i lozinka.
    -Korisnički sadržaj: Konfiguracije, linkovi za kupovinu i ostali sadržaji koje postavljate.
...
5. Prava korisnika
Kao korisnik imate pravo da:
    -Pristupite, izmenite ili obrišete svoje lične podatke.
    -Opozovete saglasnost za korišćenje svojih podataka (ukoliko je primenljivo).
Za ostvarivanje ovih prava, možete nas kontaktirati putem e-pošte.


6. Izmene Politike privatnosti
Zadržavamo pravo da u bilo kom trenutku izmenimo ovu Politiku privatnosti bez bilo kakve najave. Nastavak korišćenja sajta nakon objave izmena podrazumeva da prihvatate nove uslove.


7. Kontakt
Za sva pitanja ili zahteve vezane za privatnost, možete nas kontaktirati putem e-pošte: support@sklopi.live.',
];